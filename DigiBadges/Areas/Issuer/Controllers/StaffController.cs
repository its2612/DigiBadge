...
namespace DigiBadges.Areas.Issuer.Controllers
{
    ...
    public class StaffController : Controller
    {
        ...
        public IActionResult SelfCreated()
        {
            ...
            var userToDisplay = earnerRoleUser.Where(e => (e.CreatedBy == AppUtility.DefaultCreatedBy) || (e.CreatedBy == AppUtility.AdminRole) || (e.CreatedBy != thisIssuer.Name) || (e.CreatedBy == thisIssuer.Name)).ToList();
